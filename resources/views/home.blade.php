...
@endsection
@push('js-link')
    <script src="{{asset('dash-board/plugins/morris/morris.min.js')}}"></script>
    <script src="{{asset('dash-board/plugins/raphael/raphael-min.js')}}"></script>
    <script src="{{asset('dash-board/pages/dashborad.js')}}"></script>
@endpush
